...
void World::createworld(){
	...
	//------
	room[0].changeroomnorth = '*';
	room[0].changeroomwest = 0;
	room[0].changeroomsouth = 0;
	room[0].changeroomeast = 0;

	//House 1 Exit exit[0]
	strcpy_s(exit[0].name, "Street");
	strcpy_s(exit[0].north, "There's a wall");  strcpy_s(exit[0].west, "Street"); strcpy_s(exit[0].south, "Door of House 1"); strcpy_s(exit[0].east, "School");
	exit[0].changeroomnorth = '-'; exit[0].changeroomwest = 9; exit[0].changeroomsouth = '*';/*house 1*/ exit[0].changeroomeast = 1;
	...
	//--------
	room[1].changeroomnorth = '*';
	
	
	
	//School Exit exit[1]
	strcpy_s(exit[1].name, "Street"); strcpy_s(exit[1].north, "There's a wall"); strcpy_s(exit[1].west, "House 1"); strcpy_s(exit[1].south, "Door of School");
	...
	//-------
	room[2].changeroomnorth = '*';
	room[2].changeroomwest = 0;
	room[2].changeroomsouth = 0;
	room[2].changeroomeast = 0;
	//House 2 Exit exit[2]
	strcpy_s(exit[2].name, "Street");
	strcpy_s(exit[2].north, "There's a wall");
	strcpy_s(exit[2].west, "street");
	strcpy_s(exit[2].south, "Door of House 2");
	strcpy_s(exit[2].east, "Street");
	exit[2].changeroomnorth = '-';
	exit[2].changeroomwest = 12;
	exit[2].changeroomsouth = '*';//house 2
	exit[2].changeroomeast = 10;
	...
	//-------
	room[3].changeroomnorth = 0;
	room[3].changeroomwest = 0;
	room[3].changeroomsouth = '*';
	room[3].changeroomeast = 0;
	//shop Exit exit[3]
	strcpy_s(exit[3].name, "Street");
	strcpy_s(exit[3].north, "Door of the Shop");
	strcpy_s(exit[3].west, "A door closed");
	strcpy_s(exit[3].south, "There's a wall");
	strcpy_s(exit[3].east, "Street");
	exit[3].changeroomnorth = '*';//shop
	exit[3].changeroomwest = 100;
	exit[3].changeroomsouth = '-';
	exit[3].changeroomeast = 12;
	...
	//---------
	room[4].changeroomnorth = 0;
	room[4].changeroomwest = 0;
	room[4].changeroomsouth = '*';
	room[4].changeroomeast = 0;
	
	//cinema Exit exit[4]
	strcpy_s(exit[4].name, "Street");
	strcpy_s(exit[4].north, "Door of Cinema");
	...
	//-------------
	room[5].changeroomnorth = '*';
	room[5].changeroomwest = 0;
	room[5].changeroomsouth = 0;
	room[5].changeroomeast = 0;
	
	//House 3 Exit exit[5]
	strcpy_s(exit[5].name, "Street");
	strcpy_s(exit[5].north, "Street");
	strcpy_s(exit[5].west, "There's a door closed");
	strcpy_s(exit[5].south, "Door of House 3");
	...
	//----------
	room[6].changeroomnorth = 0;
	room[6].changeroomwest = '*';
	room[6].changeroomsouth = 0;
	room[6].changeroomeast = 0;
	//Park 2 Exit exit[6]
	strcpy_s(exit[6].name, "Street");
	strcpy_s(exit[6].north, "Street");
	strcpy_s(exit[6].west, "Cinema");
	strcpy_s(exit[6].south, "There's a wall");
	strcpy_s(exit[6].east, "Door of Park 2");
	exit[6].changeroomnorth = 11;
	exit[6].changeroomwest = 4;//house 3
	...
	strcpy_s(exit[11].north, "Street");
	strcpy_s(exit[11].west, "House 2");
	strcpy_s(exit[11].south, "Park 2");
	strcpy_s(exit[11].east, "There's a wall");
	...
	strcpy_s(exit[12].west, "Shop");
	strcpy_s(exit[12].south, "House 3");
	strcpy_s(exit[12].east, "House 2");
	exit[12].changeroomnorth = '-';
	exit[12].changeroomwest = 3;// shop
	exit[12].changeroomsouth = 5;//house 3
	exit[12].changeroomeast = 2;
}
void World::enterinhouse(int &r){
	World world;
	char direc;
	bool finaln=false, finals= false, finalw= false, finale= false;
	printf("You are inside of %s", (room[r].name));
	
	printf("%s", room[r].descriptions);
	do{
		...
		if (finalw == true || finale == true || finaln == true || finals == true){
			break;
		}
	} while (direc != 'q');
